...
export default function SignIn({ navigation, setLoggedIn }) {
  ...
  return (
    <View
      ...
      <View>
        <Image source={require('../assets/icons/LIVEFIT.png')} style={styles.logo} />
      </View>
      <TextInput placeholder='Username' placeholderTextColor='lightgrey' onChangeText={(text) => setName(text)} style={styles.input} />
      <TextInput placeholder='Password' placeholderTextColor='lightgrey' onChangeText={(text) => setPass(text)} style={styles.input} />
